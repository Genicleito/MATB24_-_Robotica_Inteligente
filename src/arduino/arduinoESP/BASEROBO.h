...
#define IR_PARA_FRENTE() do { IR_PARA_FRENTE_DIREITA(); IR_PARA_FRENTE_ESQUERDA(); Serial.println("IR_PARA_FRENTE"); } while(false)
...
#define IR_PARA_TRAS() do { IR_PARA_TRAS_DIREITA(); IR_PARA_TRAS_ESQUERDA(); Serial.println("IR_PARA_TRAS"); } while(false)
